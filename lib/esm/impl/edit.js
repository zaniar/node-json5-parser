...
export function setProperty(text, originalPath, value, formattingOptions, getInsertionIndex, isArrayInsertion) {
    var _a;
    if (isArrayInsertion === void 0) { isArrayInsertion = false; }
