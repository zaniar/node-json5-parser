...
import { createScanner, parse, getLocation, parseTree, findNodeAtLocation, getNodeValue, getNodePath, visit } from '../main';
...
function assertNodeAtLocation(input, segments, expected) {
    var actual = findNodeAtLocation(input, segments);
...
suite('JSON', function () {
    ...
    test('tree: find location', function () {
        var root = parseTree('{ "key1": { "key11": [ "val111", "val112" ] }, "key2": [ { "key21": false, "key22": 221 }, null, [{}] ] }');
